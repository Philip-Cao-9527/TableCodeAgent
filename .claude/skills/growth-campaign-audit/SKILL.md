...
- 确定性检查应由 `tests/test_workflows/`、表格工具、pytest 或 benchmark result 提供证据。
...
- helper-assisted oracle 固定多步编排应放在 `tests/test_workflows/`。
- 产品态主 Loop 应放在 `src/tablecodeagent/workflow/` 并通过 MiniClaude tool schema 暴露。
