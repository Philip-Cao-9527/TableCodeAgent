...
- 项目总览：`README.md`
- 当前架构记录：`docs/reproduce/2026-06-03_tablecodeagent_architecture.md`
- 项目动机说明：`docs/reproduce/2026-06-03_why_table_code_agent.md`
...
- `docs/reproduce/2026-06-03_tablecodeagent_architecture.md`；如果原文已经容易造成历史状态和最新状态混淆，优先更新为最新状态，必要时新建一份带日期的架构记录，并在旧文档中显式指向新文档。
